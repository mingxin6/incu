...
public class ParkingLotBikeValidator implements Validator {

	@Override
	public boolean supports(Class clazz) {
		return ParkingLotBike.class.isAssignableFrom(clazz);
	}

	@Override
	public void validate(Object target, Errors errors) {

		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "parkingLotBikeNo", "required.parkinglotbikeno",
				"停車位號碼不可空白.");
