...
public class TalkNotesByIdController_B implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		//System.out.println("pcn.companyName"+pcn.companyName);
		request.setAttribute("compId", compId);
		session.setAttribute("tnlist", list);

		return new ModelAndView("talkNotesById_B", "tnlist", null);
	}
}
