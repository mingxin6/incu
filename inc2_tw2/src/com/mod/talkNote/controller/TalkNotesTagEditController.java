...
public class TalkNotesTagEditController extends SimpleFormController {

	public TalkNotesTagEditController() {
...
//		
//		MySQLAccessTalkNote o = new MySQLAccessTalkNote();
//		o.updateTalkNoteTags(tagRec);

		return new ModelAndView(new RedirectView("TalkNotesViewFromList.htm?talkNoteId=" + talkNotes.getTalkNoteId()));
	}
