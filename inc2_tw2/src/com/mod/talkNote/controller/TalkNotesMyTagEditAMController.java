...
public class TalkNotesMyTagEditAMController extends SimpleFormController {

	public TalkNotesMyTagEditAMController() {
	...
	protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command,
		...
		return new ModelAndView(new RedirectView("talkNotesMyViewAM.htm?talkNoteId=" + talkNotes.getTalkNoteId()));
	}
