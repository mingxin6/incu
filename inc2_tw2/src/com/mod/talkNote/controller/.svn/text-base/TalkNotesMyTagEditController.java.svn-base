...
public class TalkNotesMyTagEditController extends SimpleFormController {

	public TalkNotesMyTagEditController() {
	...
	protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command,
		...
		return new ModelAndView(new RedirectView("talkNotesMyView.htm?talkNoteId=" + talkNotes.getTalkNoteId()));
	}
