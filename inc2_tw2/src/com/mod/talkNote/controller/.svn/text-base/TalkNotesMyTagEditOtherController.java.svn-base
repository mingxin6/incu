...
public class TalkNotesMyTagEditOtherController extends SimpleFormController {

	public TalkNotesMyTagEditOtherController() {
	...
	protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command,
		...
		return new ModelAndView(new RedirectView("talkNotesMyViewOther.htm?talkNoteId=" + talkNotes.getTalkNoteId()));
	}
