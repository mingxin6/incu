...
public class MySQLAccessAdministrator {

	public ArrayList findAllAdministrators() {
		MySQLAccessMyBatis o = new MySQLAccessMyBatis();
		o.openSession();
		ArrayList recs = (ArrayList) o.findAllAdministrators();
		o.closeSession();
		return recs;
	}
	...
	public Administrator findAdministratorById(String uid) {
		MySQLAccessMyBatis o = new MySQLAccessMyBatis();
		o.openSession();
		Administrator obj = o.findAdministratorById(uid);
	...
	public User fillUserObjOfAdministrator(Administrator obj) {
		User user = new User();
	...
	public void insertAdministrators(Administrator obj, HttpServletRequest request) throws Exception {
		MySQLAccessMyBatis o = new MySQLAccessMyBatis();
		o.openSession();
		obj.setUid("Administrator" + KeyMaker.newKey());
		...
		o.insertAdministrators(obj);

		User user = fillUserObjOfAdministrator(obj);
		o.insertUser(user);
	...
	public void updateAdministrator(Administrator obj, HttpServletRequest request) throws Exception {
		MySQLAccessMyBatis o = new MySQLAccessMyBatis();
		o.openSession();
	...
	public void deleteAdministrator(String uid, HttpServletRequest request) throws Exception {
		MySQLAccessMyBatis o = new MySQLAccessMyBatis();
		o.openSession();
