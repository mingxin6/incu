...
public class CashierListController extends SimpleFormController {

	public CashierListController() {
	...
	protected ModelAndView onSubmit(HttpServletRequest request,
		...
		request.setAttribute("cashierList", ar);
		return new ModelAndView("cashierList", "voYearMonthCondition",
	...
	protected Map referenceData(HttpServletRequest request) throws Exception {
		...
		referenceData.put("cashierList", ar);
