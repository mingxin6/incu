...
public class StaffEditValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		//---------------------------------------------------
		Staff stf = (Staff) target;
		String newId = stf.getUserLoginId();

		MySQLAccessStaff o = new MySQLAccessStaff();
		Staff staff = o.findStaffById(stf.getUid());

		if (!newId.equals(staff.getUserLoginId())) {
