...
public class SecurityCardValidator implements Validator {

	@Override
	public boolean supports(Class clazz) {
		return SecurityCard.class.isAssignableFrom(clazz);
	}

	@Override
	public void validate(Object target, Errors errors) {

		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "securityCardNo", "required.securitycardno",
				"門禁卡號碼不可空白.");
