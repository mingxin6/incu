...
public class ServiceResourceAcceptListController extends SimpleFormController {
	
	public ServiceResourceAcceptListController() {
	...
	protected Map referenceData(HttpServletRequest request) throws Exception {
		...
		try {
				al = o.readServiceResourceAcceptList(strCategorize,null);
