...
public class ServiceResourceDataViewController extends SimpleFormController {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		String str_id = "";
		str_id = request.getParameter("aid");
		...
		return new ModelAndView("serviceResourceDataView", "serviceResourceData", obj);
