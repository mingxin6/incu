...
public class AnnouncementViewController extends SimpleFormController {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		String topicId = "";
		topicId = request.getParameter("aid");
...
//			System.out.println("userid=" + user.getUserid() + ", user.getUserComp()=" + user.getUserComp());
		...
		System.out.println("str_id=" + topicId);

		Announcement obj = new Announcement();
		MySQLAccess o = new MySQLAccess();
		try {
			obj = o.readAnnouncementByID(topicId, user);
		...
		try {
		 ...
		 return new ModelAndView("announcementView", "announcement", obj);
