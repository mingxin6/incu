...
public class MonthlyReportOfComps2 extends SimpleFormController {

	public MonthlyReportOfComps2() {
	...
	protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command,
		...
		//
		return new ModelAndView("MonthlyReportsOfAllComps", "voMonthlyReportCondition", voMonthlyReportCondition);
