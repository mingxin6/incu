...
public class QuarterlyReportOfCompsConfirmedExcelController extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map model, HSSFWorkbook workbook, HttpServletRequest request,
		...
		String yearQuarter = (String) mp.get("yearQuarter");
		...
		HSSFSheet sheet = ExcelUtil.getSheet(workbook, yearQuarter + " 企业季報表", "企业名称");
