		...
		<div id="container">
			...
			<div id="listCon">
				...
				<c:if test="${user.isStaff}">
					<a href="meetingRoomAdd.htm" class="addBtn"><s:message code="meetingRoom.new" text="新增會議室" /></a>
				</c:if>
						...
						<tr>
							<td align="left">
								<span style="font-size: 14"><a
									href="meetingRoomView.htm?uid=${meetingRoom.uid}">${meetingRoom.meetingRoomNo}</a> </span>
							</td>
							...
							<td align="left">
								<span style="font-size: 14">${meetingRoom.remark}</span>
							</td>

							<td align="left">
								<span style="font-size: 14">${meetingRoom.entityStatusRS}</span>
							</td>
