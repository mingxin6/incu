...
$(document).ready(function() {
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				您的位置>${compName}>修改出納人員資訊
			</h2>

			<div id="listCon">
				<form:form id="myform" method="POST" commandName="cashier"
					enctype="multipart/form-data" acceptcharset="UTF-8">

					<form:errors path="*" cssClass="errorblock" element="div" />

					<a href="cashierView.htm?uid=${cashier.uid}" class="saveIcon">回內容</a> | <a
...
<%--
						...
						<tr>
							...
							<td>
								...
								<textarea name="msgpost" id="msgpost" cols="45" rows="10">${cashier.remark}</textarea>
...
<tr>
						...
						<tr>
							...
							<td WIDTH="90%">
								<form:password path="userLoginPwdClearText" size="80" />
								&nbsp;	（若要更改密碼, 請於左側空白處輸入新密碼.）
