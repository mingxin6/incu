...
<html>
	<head>
		...
		<title><s:message code="talknotes.list" text="輔導記錄" /></title>
...
-->
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				<s:message code="my.your.position" text="您的位置" />> ${compName}<s:message code="talknotes.list" text="輔導記錄" />
			</h2>

			<div id="listCon">

				<a href="talkNotesList.htm" class="formIcon"><s:message code="my.back.to.list" text="回列表" /></a>
				
				<a href="talkNotesTagEdit.htm?talkNoteId=${TalkNotes.talkNoteId}"
