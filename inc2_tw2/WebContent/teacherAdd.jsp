...
<html>
	<head>
		...
		<title><s:message code="teacher.new" text="新增業師" /></title>
...
$(document).ready(function() {
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				<s:message
						code="my.your.position" text="您的位置" />>${compName}><s:message code="teacher.new" text="新增業師" />
			</h2>
			...
			<div id="listCon">
				<form:form id="myform" method="POST" commandName="teacher"
					...
					<a href="teacherList.htm" class="formIcon"><s:message code="my.back.to.list" text="回列表" /></a> | <a
