...
$(document).ready(function() {
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				您的位置>${compName}>修改企業用戶資訊
			</h2>

			<div id="listCon">
				<form:form id="myform" method="POST" commandName="companyUser"
					enctype="multipart/form-data" acceptcharset="UTF-8">

					<form:errors path="*" cssClass="errorblock" element="div" />

					<a href="companyUserView.htm?uid=${companyUser.uid}" class="saveIcon">回內容</a> | <a
					...
					<tr>
						...
						<tr>
							...
							<td>
								...
								<textarea name="msgpost" id="msgpost" cols="45" rows="10">${companyUser.remark}</textarea>
						...
						<tr>
							...
							<td>
								...
								<textarea name="msgpost2" id="msgpost2" cols="45" rows="10">${companyUser.officeHour}</textarea>
...
--%>
						...
						<tr>
							...
							<td WIDTH="90%">
								<form:input path="userLoginPwdClearText" size="80" />（若要更改密碼, 請於左側空白處輸入新密碼.）
								&nbsp;
