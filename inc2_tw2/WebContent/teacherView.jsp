...
$(document).ready(function() {
	...
	$("#dialog").dialog( {
		...
		buttons : {
			...
			$(this).dialog("close");
			self.location = "teacherDelete.htm?uid=${teacher.uid}";
		},
		"否" : function() {
			$(this).dialog("close");
		}
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<div id="listCon">
				...
				<a href="teacherList.htm" class="formIcon"><s:message
						code="my.back.to.list" text="回列表" /> </a>

				<c:if test="${user.isStaff}">
					<a href="teacherEdit.htm?uid=${teacher.uid}" class="formIcon"><s:message
							code="my.edit" text="編輯" />
					</a>
