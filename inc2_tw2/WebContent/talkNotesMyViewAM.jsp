...
<html>
	<head>
		...
		<title><s:message code="AM.consulting.record" text="AM 輔導記錄" /></title>
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				...
				> ${compName}
				<s:message code="AM.consulting.record" text="AM 輔導記錄" />
			</h2>

			<div id="listCon">

				<a href="talkNotesMyListAM.htm" class="formIcon"><s:message
						code="my.back.to.list" text="回列表" />
				</a>
				<c:if test="${!TalkNotes.closed}">
					<a href="talkNotesMyEditAM.htm?talkNoteId=${TalkNotes.talkNoteId}"
						class="formIcon"><s:message code="my.edit" text="編輯" />
					</a>
				</c:if>
				<a
					href="talkNotesMyTagEditAM.htm?talkNoteId=${TalkNotes.talkNoteId}"
