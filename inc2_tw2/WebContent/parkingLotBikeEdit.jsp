...
<html>
	<head>
		...
		<title><s:message code="parking.bike.info.modify" text="修改停車位資訊" /></title>
...
$(document).ready(function() {
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				<s:message
						code="my.your.position" text="您的位置" />><s:message code="parking.bike.info.modify" text="修改停車位資訊" />
			</h2>

			<div id="listCon">
				<form:form id="myform" method="POST" commandName="parkingLotBike"
					enctype="multipart/form-data" acceptcharset="UTF-8">

					<form:errors path="*" cssClass="errorblock" element="div" />

					<a href="parkingLotBikeView.htm?uid=${parkingLotBike.uid}" class="formIcon"><s:message code="my.back.to.content" text="回內容" /></a> | <a
					...
					<table width=98% border="1" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td>
								<form:input path="parkingLotBikeNo" size="80" />
								&nbsp;
								<form:errors path="parkingLotBikeNo" cssClass="error" />
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								...
								<textarea name="msgpost" id="msgpost" cols="45" rows="10">${parkingLotBike.remark}</textarea>
