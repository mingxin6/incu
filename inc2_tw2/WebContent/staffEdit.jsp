...
<html>
	<head>
		...
		<title><s:message code="staff.modify" text="修改中心人員資訊" /></title>
...
$(document).ready(function() {
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				<s:message
						code="my.your.position" text="您的位置" />>${compName}><s:message code="staff.modify" text="修改中心人員資訊" />
			</h2>
			...
			<div id="listCon">
				<form:form id="myform" method="POST" commandName="staff"
					...
					<a href="staffView.htm?uid=${staff.uid}" class="formIcon"><s:message code="my.back.to.content" text="回內容" /></a> | <a
...
--%>
						...
						<tr>
							...
							<td>
								...
								<textarea name="msgpost2" id="msgpost2" cols="45" rows="10">${staff.officeHour}</textarea>
