		...
		<div id="container">
			...
			<div id="listCon">
				...
				<form:form id="myform" method="POST" commandName="announcement"
					...
					<a href="announcementList.htm" class="reIcon">回列表</a> | <a
					...
					<table border='1' cellpadding="0" cellspacing="0" class="listTable"
						...
						<tr>
							...
							<td WIDTH="90%">
								<form:input path="createDate" size="80" />
								&nbsp;
...
-->
					...
					<input id="addFile" type="button" value="增加一列" class="upIcon" />
