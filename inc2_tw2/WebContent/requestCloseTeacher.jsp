...
<html>
	<head>
		...
		<title><s:message code="request.teacher.close" text="業師 輔導結案" /></title>
...
function submitform() {
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				<s:message code="request.teacher.close" text="業師 輔導結案" /> - ${TalkNotes.consultantName}
			</h2>
			...
			<div id="listCon">
				...
				<form:form id="myform" method="POST" commandName="TalkNotes"
					...
					<a href="requestViewTeacher.htm?noteId=${TalkNotes.talkNoteId}"
