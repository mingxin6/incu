		...
		<div id="container">
			...
			<div id="listCon">
				<form:form id="myform" method="POST" commandName="talkNotes"
					...
					<a
						href="TalkNotesById.htm?compName=${compName}&compId=${talkNotes.compId}"
						class="formIcon">回列表</a> | <a href="javascript:submitform()"
						class="okIcon">儲存</a>
					...
					<table width=98% border="1" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td>
								...
								<textarea name="msgpost" id="msgpost" cols="45" rows="10">${talkNotes.talkContent}</textarea>
