...
<html>
	<head>
		...
		<title><s:message code="room.add" text="新增培育間" /></title>
...
$(function() {
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				<s:message
						code="my.your.position" text="您的位置" />>
				<s:message code="room.add" text="新增培育間" />
			</h2>
			...
			<div id="listCon">
				<form:form id="myform" method="POST" commandName="room"
					...
					<a href="roomList.htm" class="formIcon"><s:message
 ...
 --%>
						...
						<tr>
							...
							<td WIDTH="90%">
								<form:input path="roomNo" size="80" />
								&nbsp;
								<form:errors path="roomNo" cssClass="error" />
							</td>
						</tr>
						...
						<tr>
							...
							<td WIDTH="90%">
								<form:input id="tags" path="compName" size="80" />
								&nbsp;
						...
						<tr>
							...
							<td WIDTH="90%">
								<form:input path="roomArea" size="80" />
								&nbsp;
						...
						<tr>
							...
							<td>
								...
								<textarea name="msgpost" id="msgpost" cols="45" rows="10">${room.remark}</textarea>
