...
<html>
	<head>
		...
		<title><s:message code="edit.PM.consulting.record"
				text="編輯 PM 輔導記錄" />
		</title>
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				...
				>${compName}>
				<s:message code="edit.PM.consulting.record" text="編輯 PM 輔導記錄" />
			</h2>
			...
			<div id="listCon">
				...
				<a href="talkNotesMyViewPM.htm?talkNoteId=${talkNotes.talkNoteId}"
