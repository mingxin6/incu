...
<html>
	<head>
		...
		<title><s:message code="room.info" text="培育間資訊" /></title>
...
$(document).ready(function() {
	...
	$("#dialog").dialog( {
		...
		buttons : {
			...
			$(this).dialog("close");
			self.location = "roomDelete.htm?uid=${room.uid}";
		},
		"否" : function() {
			$(this).dialog("close");
		}
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				...
				>
				<s:message code="room.info" text="培育間資訊" />
			</h2>
			...
			<div id="listCon">
				...
				<c:if test="${user.isStaff}">
					<a href="roomEdit.htm?uid=${room.uid}" class="formIcon"><s:message
							code="my.edit" text="編輯" /> </a>
					<a href="roomClear.htm?uid=${room.uid}" class="formIcon"><s:message
							code="my.clear" text="清除使用人" /> </a>
