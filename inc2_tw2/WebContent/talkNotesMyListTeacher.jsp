...
<html>
	...
	<body>
		...
		<div id="container">
			...
			<h2 id="listTit">
				<s:message code="yourposition"  />><s:message code="menuPart.consult.management"  />><span><s:message code="menuPart.consult.teacher" /></span>
			</h2>

			<div id="listCon">
				<div class="midCon">
					<form:form method="POST"
						commandName="TalkNotesMyListTeacherController">
						<table>
							<tr>
								<td align="right">
						...
						<tr>
							...
							<td align="left">
								<span style="font-size: 14"><a
									href="talkNotesMyViewTeacher.htm?compName=${compName}&compId=${compId}&talkNoteId=${talkNotes.talkNoteId}">${talkNotes.talkTheme}</a>
								</span>
							</td>
