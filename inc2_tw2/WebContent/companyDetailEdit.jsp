		...
		<div id="container">
			...
			<div id="listCon">
				...
				<form:form id="myform" method="POST" commandName="comp"
					...
					<a href="compList.htm" class="formIcon"><s:message code="button.backlist"  text="回列表" /></a>
					<!-- <a href="compDetailView.htm?compID=${comp.uid}" class="formIcon"><s:message code="button.back"  text="返回" /></a> -->
					...
					<div class="collapse-wrapper">
						...
						<div class="collapse-box">
							<table border='1' cellpadding="0" cellspacing="0"
								class="listTable" WIDTH="90%">
								<tr>
									<th align="right" WIDTH="25%" bgcolor=#CCCCCC>
										<span class="tipneed">*</span><s:message code="compnew.id"  text="編號" />：
									</th>
									<td WIDTH="25%">
										<c:choose>
									...
									<th align="right" WIDTH="25%">
										<span class="tipneed">*</span><s:message code="compnew.id2"  text="統一編號" />：
									</th>
									<td WIDTH="25%">
										<form:input path="registerId" size="25" />
										&nbsp;
								...
								<tr>
									...
									<td>
										<form:input path="compName" size="25" />
										&nbsp;
									...
									<td>
										<form:input path="compEngName" size="25" />
										&nbsp;
										<form:errors path="compEngName" cssClass="error" />
									</td>
								</tr>
								<tr>
									<th align="right" bgcolor=#CCCCCC>
									...
									<td>
										<form:input path="compShortName" size="25" />
										&nbsp;
										<form:errors path="compShortName" cssClass="error" />
									</td>
									<th align="right" bgcolor=#CCCCCC>
								...
								<tr>
									...
									<td>
										<form:input path="representative" size="25" />
										&nbsp;
								...
								<tr>
									...
									<td>
										<form:input id="pickMoveInDate" path="moveInDate" size="25" />
										&nbsp;
								...
								<tr>
									...
									<td>
										<form:input path="totalEmployees" size="25" />
										&nbsp;
									...
									<td>
										<form:input path="registerCaptial" size="25" />
										&nbsp;
								...
								<tr>
									...
									<td>
										<form:input path="actualCaptial" size="25" />
										&nbsp;
										<form:errors path="actualCaptial" cssClass="error" />
									</td>
									<th align="right">
										&nbsp;
									</th>
								...
								<tr>
									...
									<td>
										<form:input path="compWebURL" size="25" />
										&nbsp;
										<form:errors path="compWebURL" cssClass="error" />
									</td>
									<th align="right">
										<s:message code="compnew.mainproduct"  text="主力產品" />：
									</th>
									<td>
										<form:input path="prod" size="25" />
										&nbsp;
										<form:errors path="prod" cssClass="error" />
									</td>
								</tr>
								<tr>
									<th align="right">
								...
								<tr>
									...
									<td colspan="3">
										<form:hidden path="compIntroduction" />
										<textarea name="msgpost" id="msgpost" cols="30" rows="10">${comp.compIntroduction}</textarea>
										<form:errors path="compIntroduction" cssClass="error" />
									</td>
...
--%>
								...
								<tr>
									...
									<td colspan="3">
										...
										<textarea name="msgpost2" id="msgpost2" cols="30" rows="10">${comp.remark}</textarea>
						...
						<div class="collapse-box">
							<table border='1' cellpadding="0" cellspacing="0"
								...
								<tr>
									...
									<td WIDTH="25%">
										<form:input path="boss" size="25" />
										&nbsp;
										<form:errors path="boss" cssClass="error" />
									</td>
									<th align="right" WIDTH="25%">
								...
								<tr>
									...
									<td>
										<form:input path="mobilePhone" size="25" />
										&nbsp;
								...
								<tr>
									...
									<td>
										<form:input path="adminContact" size="25" />
										&nbsp;
									...
									<td>
										<form:input path="adminContactPhone" size="25" />
										&nbsp;
								...
								<tr>
									...
									<td>
										<form:input path="adminContactMobilePhone" size="25" />
										&nbsp;
									...
									<td>
										<form:input path="adminContactEmail" size="25" />
										&nbsp;
						...
						<div class="collapse-box">
							<table border='1' cellpadding="0" cellspacing="0"
								...
								<tr>
									...
									<td WIDTH="25%">
										<form:input path="contractNumber" size="25" />
										&nbsp;
										<form:errors path="contractNumber" cssClass="error" />
									</td>
									<th align="right" WIDTH="25%">
										<s:message code="compnew.contractbegin"  text="合約起日" />：
									</th>
									<td WIDTH="25%">
										<form:input id="pickContractStartDate" path="contractStartDate" size="25" />
										&nbsp;
								...
								<tr>
									...
									<td>
										<form:input id="pickContractEndDate"  path="contractEndDate" size="25" />
										&nbsp;
						...
						<div class="collapse-box">
							<table border='1' cellpadding="0" cellspacing="0"
								...
								<tr>
									...
									<td WIDTH="25%">
										<form:input id="pickMoveOutDate" path="moveOutDate" size="25" />
										&nbsp;
									...
									<td WIDTH="25%">
										<form:input path="moveOutAddesss" size="25" />
										&nbsp;
										<form:errors path="moveOutAddesss" cssClass="error" />
									</td>
								</tr>
							</table>
						</div>
