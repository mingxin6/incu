...
$(document).ready(function() {
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				您的位置> ${compName}企業用戶資訊
			</h2>

			<div id="listCon">

				<a href="companyUserList.htm" class="formIcon">回列表</a>

				<c:if test="${user.isStaff}">
				|<a href="companyUserEdit.htm?uid=${companyUser.uid}" class="saveIcon">編輯</a>
				|<a href="companyUserDelete.htm?uid=${companyUser.uid}" class="saveIcon">刪除</a>
				</c:if>
