 ...
 -->
			<div id="listCon">
				...
				<form:form id="myform" method="POST" commandName="notify"
					...
					| <a href="javascript:submitform()" class="formIcon"><s:message code="button.send" text="發送" /></a>
					...
					<table width=98% border="1" cellpadding="0" cellspacing="0"
						...
						<tr>
							<th align="center" width="10%" WIDTH="25%" bgcolor=#CCCCCC>
								<s:message code="reviewpaperclose.subject" text="主旨" />：
							</th>
							<td WIDTH="90%">
								<form:input path="subject" size="10" />
								&nbsp;
						...
						<tr>
							<th align="center">
								<s:message code="reviewpaperclose.content" text="內容" />：
							</th>
							<td>
					...
					<br />
					<div>
						<s:message code="reviewpaperclose.recipient" text="收件人" />:
					</div>
					<table>
