...
<html>
	<head>
		...
		<title><s:message code="parking.info.modify" text="修改停車位資訊" /></title>
...
$(document).ready(function() {
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				<s:message
						code="my.your.position" text="您的位置" />><s:message code="parking.info.modify" text="修改停車位資訊" />
			</h2>
			...
			<div id="listCon">
				<form:form id="myform" method="POST" commandName="parkingLot"
					...
					<a href="parkingLotView.htm?uid=${parkingLot.uid}" class="formIcon"><s:message code="my.back.to.content" text="回內容" /></a> | <a
