...
<html>
	<head>
		...
		<title><s:message code="outsource.info" text="委外項目資訊" />
		</title>
...
$(document).ready(function() {
	...
	$("#dialog").dialog( {
		...
		buttons : {
			...
			$(this).dialog("close");
			self.location = "outsourceDelete.htm?uid=${outsource.uid}";
		},
		"否" : function() {
			$(this).dialog("close");
		}
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				...
				> ${compName}
				<s:message code="outsource.info" text="委外項目資訊" />
			</h2>

			<div id="listCon">

				<a href="outsourceList.htm" class="formIcon"><s:message
						code="my.back.to.list" text="回列表" /> </a>

				<c:if test="${user.isStaff}">
					<a href="outsourceEdit.htm?uid=${outsource.uid}" class="formIcon"><s:message
