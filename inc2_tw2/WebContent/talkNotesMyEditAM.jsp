...
<html>
	<head>
		...
		<title><s:message code="edit.AM.consulting.record" text="編輯 AM 輔導記錄" /></title>
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				...
				>${compName}><s:message code="edit.AM.consulting.record" text="編輯 AM 輔導記錄" />
			</h2>
							...
							<td>
								<c:forEach items="${talkNotes.fileInfo_reply}" var="obj">
									<input type="checkbox" name="deleteCheck"
										value="${obj.modifiedFileName}" /> <s:message code="my.delete" text="刪除" />
								<a
										href="downLoadFile.htm?aid=${talkNotes.talkNoteId}&fName=${obj.originalFileName}&mName=${obj.modifiedFileName}">${obj.originalFileName}</a>
									<br>
								</c:forEach>
