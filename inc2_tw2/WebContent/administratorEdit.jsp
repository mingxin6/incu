...
<!-- 
			<h2 id="listTit">
				您的位置>${compName}>修改系統管理員資訊
			</h2> -->

			<div id="listCon">
				<form:form id="myform" method="POST" commandName="administrator"
					enctype="multipart/form-data" acceptcharset="UTF-8">

					<form:errors path="*" cssClass="errorblock" element="div" />

					<a href="administratorView.htm?uid=${administrator.uid}" class="formIcon"><s:message code="button.backcontent" text="回內容" /></a> | <a
						href="javascript:submitform()" class="formIcon"><s:message code="button.save" text="儲存" /></a>
...
<%--
						...
						<tr>
							...
							<td>
								...
								<textarea name="msgpost" id="msgpost" cols="45" rows="10">${administrator.remark}</textarea>
...
<tr>
							<th align="center" width="10%" WIDTH="25%" bgcolor=#CCCCCC>
								<s:message code="administratoradd.account" text="帳號" />：
							</th>
							<td WIDTH="90%">
						...
						<tr>
							<th align="center" width="10%" WIDTH="25%" bgcolor=#CCCCCC>
								<s:message code="administratoradd.password" text="密碼" />：
							</th>
							<td WIDTH="90%">
								<form:input path="userLoginPwdClearText" size="80" />
								&nbsp;	（<s:message code="administratoradd.tip" text="若要更改密碼, 請於左側空白處輸入新密碼." />）
						...
						<tr>
							<th align="center" width="10%" WIDTH="25%" bgcolor=#CCCCCC>
								<s:message code="button.save" text="狀態" /> :
							</th>
							<td>
