		...
		<div id="container">
			...
			<div id="listCon">
				...
				<c:if test="${user.isStaff}">
					<a href="parkingLotAdd.htm" class="addBtn"><s:message code="parking.new" text="新增停車位" /></a>
				</c:if>
						...
						<tr>
							<td align="left">
								<span style="font-size: 14"><a
									href="parkingLotView.htm?uid=${parkingLot.uid}">${parkingLot.parkingLotNo}</a> </span>
							</td>

							<td align="left">
								<span style="font-size: 14">${parkingLot.usedBy}</span>
							</td>


							<td align="left">
								<span style="font-size: 14">${parkingLot.remark}</span>
							</td>

							<td align="left">
								<span style="font-size: 14">${parkingLot.entityStatusRS}</span>
							</td>
