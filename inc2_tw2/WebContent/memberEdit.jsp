...
$(document).ready(function() {
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				您的位置>${compName}>修改會員資訊
			</h2>

			<div id="listCon">
				<form:form id="myform" method="POST" commandName="member"
					enctype="multipart/form-data" acceptcharset="UTF-8">

					<form:errors path="*" cssClass="errorblock" element="div" />

					<a href="memberView.htm?uid=${member.uid}" class="saveIcon">回內容</a> | <a
					...
					<table width=98% border="1" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td>
								...
								<textarea name="msgpost" id="msgpost" cols="45" rows="10">${member.remark}</textarea>
