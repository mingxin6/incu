...
<body >
	...
	<div id="container">
		...
		<h2 id="listTit">您的位置>統計報表><span>年報表</span></h2>

		<div id="listCon">
            <div class="temCon">
                <form:form method="POST" commandName="voYearlyReportCondition">
                    <table width="540">
                        <tr>
                            <td>自:</td>
		...
		<a href="ExcelController.htm?output=ExcelYearlyReportView" class="exportBtn">輸 出 Excel 表</a>

		<!-- xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx -->

		<table width="1228" height="122" border="1" cellpadding="0" cellspacing="0" class="temTable">
			<tr>
				<th rowspan="2" valign="middle">年</th>
				<th rowspan="2" valign="center">銷售額(萬元)</th>
				...
				<tr>
					<td><c:choose>
							...
							<c:when test="${mr.value.status}">
								<a href="theYearReports.htm?key=${mr.key}&output=view">${mr.key}</a>
							</c:when>
							<c:otherwise>
