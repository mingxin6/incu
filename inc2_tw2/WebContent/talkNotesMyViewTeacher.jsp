...
<html>
	<head>
		...
		<title><s:message code="teacher.consulting.record"
				text="業師輔導記錄" />
		</title>
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				...
				>
				<s:message code="teacher.consulting.record" text="業師輔導記錄" />
			</h2>
			...
			<div id="listCon">
				...
				<c:if test="${!TalkNotes.closed}">
					<a
						href="talkNotesMyEditTeacher.htm?talkNoteId=${TalkNotes.talkNoteId}"
						class="formIcon"><s:message code="my.edit" text="編輯" />
					</a>
				</c:if>
				<a
					href="talkNotesMyTagEditTeacher.htm?talkNoteId=${TalkNotes.talkNoteId}"
