...
<html>
	...
	<body>
		...
		<div id="container">
			...
			<h2 id="listTit">
				<span><s:message code="request.PM.list" text="PM 輔導紀錄" /> </span>
			</h2>

			<div id="listCon">
				<div class="midCon">
					<form:form method="POST" commandName="RequestListPMController">
						<table>
							<tr>
								<td align="right">
				...
				<c:if test="${pmName!='(尚未指定)'}">

					<a href="requestAddPM.htm?pmName=${pmName}" class="formIcon"><s:message
							code="request.PM" text="申請 PM" />
					</a> (${pmName})
				</c:if>

				<c:if test="${pmName=='(尚未指定)'}">
					<s:message code="my.PM.not.assigned" text="尚未指定 PM" />
				</c:if>
...
-->
							...
							<td align="left">
								<span style="font-size: 14"><a
									href="requestViewPM.htm?noteId=${talkNotes.talkNoteId}">${talkNotes.talkTheme}</a>
								</span>
							</td>
