...
<html>
	<head>
		...
		<title><s:message code="teacher.info.modify" text="修改業師資訊" /></title>
...
$(document).ready(function() {
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				<s:message
						code="my.your.position" text="您的位置" />>${compName}><s:message code="teacher.info.modify" text="修改業師資訊" />
			</h2>

			<div id="listCon">
				<form:form id="myform" method="POST" commandName="teacher"
					enctype="multipart/form-data" acceptcharset="UTF-8">

					<form:errors path="*" cssClass="errorblock" element="div" />

					<a href="teacherView.htm?uid=${teacher.uid}" class="formIcon"><s:message code="my.back.to.content" text="回內容" /></a> | <a
					...
					<table width=98% border="1" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td>
								...
								<textarea name="msgpost" id="msgpost" cols="45" rows="10">${teacher.remark}</textarea>
						...
						<tr>
							...
							<td>
								...
								<textarea name="msgpost2" id="msgpost2" cols="45" rows="10">${teacher.officeHour}</textarea>
