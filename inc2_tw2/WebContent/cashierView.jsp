...
$(document).ready(function() {
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				您的位置> ${compName}出納人員資訊
			</h2>

			<div id="listCon">

				<a href="cashierList.htm" class="formIcon">回列表</a>

				<c:if test="${user.isStaff}">
				|<a href="cashierEdit.htm?uid=${cashier.uid}" class="saveIcon">編輯</a>
				|<a href="cashierDelete.htm?uid=${cashier.uid}" class="saveIcon">刪除</a>
				</c:if>
