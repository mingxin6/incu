...
<div class="hellodiv">
	...
	<div class="homeimg">
		<a href="adminMain.htm"><img src="images_mu/home.png"
			height="30px" title='<s:message code="menuPart.s1" text="首頁" />' /></a>
	</div>
	...
	<div class="langchoice">
		...
		<c:if test="${not empty pageContext.request.queryString}">
			...
			<c:if
				...
				<a
					href="${forward.request_uri}?${pageContext.request.queryString}&language=zh_TW">繁體</a>|<a
	...
	<div class="exitimg">
		<a href="login.htm"><img src="images_mu/exit.png" height="20px"
			title='<s:message
							code="menuPart.logout" text="登出" />' /></a>
	</div>
</div>