...
<html>
	...
	<body>
		...
		<div id="container">
			...
			<h2 id="listTit">
				<span><s:message code="request.AM.list" text="AM 輔導紀錄" /> </span>
			</h2>

			<div id="listCon">
				<div class="midCon">
					<form:form method="POST" commandName="RequestListAMController">
						<table>
							<tr>
								<td align="right">
				...
				<c:if test="${amName!='(尚未指定)'}">

					<a href="requestAddAM.htm?amName=${amName}" class="formIcon"><s:message
							code='request.AM' text='申請 AM' /> </a> (${amName})

				</c:if>

				<c:if test="${amName=='(尚未指定)'}">
					<s:message code="my.AM.not.assigned" text="尚未指定 AM" />
				</c:if>
...
-->
							...
							<td align="left">
								<span style="font-size: 14"><a
									href="requestViewAM.htm?noteId=${talkNotes.talkNoteId}">${talkNotes.talkTheme}</a>
								</span>
							</td>
