...
<html>
	<head>
		...
		<title><s:message code="Other.consulting.record" text="其它輔導記錄" /></title>
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<div id="listCon">
				...
				<a href="talkNotesMyListOther.htm" class="formIcon"><s:message code="my.back.to.list" text="回列表" /></a>
				<c:if test="${!TalkNotes.closed}">
					<a href="talkNotesMyEditOther.htm?talkNoteId=${TalkNotes.talkNoteId}"
						class="formIcon"><s:message code="my.edit" text="編輯" /></a>
				</c:if>
				<a href="talkNotesMyTagEditOther.htm?talkNoteId=${TalkNotes.talkNoteId}"
