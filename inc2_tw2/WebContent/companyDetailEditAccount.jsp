...
<title><s:message code="menuPart.movin.management" text="進駐管理" />
	&gt;<s:message code="menuPart.movin.business" text="進駐企業" />&gt;<s:message
		...
		code="my.edit.account" text="編輯帳號資料" /></title>
...
<body class="yui-skin-sam">
	...
	<div id="container">
		...
		<div class="contentdiv">
			<div class="header">
				<s:message code="my.edit.account" text="編輯帳號資料" />
			</div>
			...
			<form:form id="myform" method="POST" commandName="comp"
				...
				<table class="table-nogrid" WIDTH="98%">
					<tr>
						<th align="right" width="15%">帳號：</th>
						<td><form:input path="userLoginId" size="40" /> &nbsp; <form:errors
								path="userLoginId" cssClass="error" /></td>
					</tr>
					<tr>
						<th align="right" width="15%">密碼：</th>
						<td><form:password path="userLoginPwdClearText" size="40" />
							（若要更改密碼, 請於左側空白處輸入新密碼.） &nbsp; <form:errors
								path="userLoginPwdClearText" cssClass="error" /></td>
					</tr>
					<tr>
						<th align="right" width="5%">狀態：</th>
