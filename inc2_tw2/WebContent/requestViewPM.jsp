...
<html>
	<head>
		...
		<title><s:message code="request.PM" text="申請 PM 輔導" /></title>
...
-->
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				<s:message code="request.PM" text="申請 PM 輔導" /> - ${TalkNotes.consultantName}
			</h2>
			...
			<div id="listCon">
				...
				<c:if test="${!TalkNotes.closed}">
					...
					<a href="requestClosePM.htm?noteId=${TalkNotes.talkNoteId}"
