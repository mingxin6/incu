...
<html>
	<head>
		...
		<title><s:message code="securitycard.info" text="門禁卡資訊" /></title>
...
$(document).ready(function() {
	...
	$("#dialog").dialog( {
		...
		buttons : {
			...
			$(this).dialog("close");
			self.location = "securityCardDelete.htm?uid=${securityCard.uid}";
		},
		"否" : function() {
			$(this).dialog("close");
		}
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				...
				>
				<s:message code="securitycard.info" text="門禁卡資訊" />
			</h2>
			...
			<div id="listCon">
				...
				<c:if test="${user.isStaff}">
					<a href="securityCardEdit.htm?uid=${securityCard.uid}"
						class="formIcon"><s:message code="my.edit" text="編輯" /> </a>
					<a href="securityCardClear.htm?uid=${securityCard.uid}"
