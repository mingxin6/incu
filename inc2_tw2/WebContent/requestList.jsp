...
<html>
	...
	<body>
		...
		<div id="container">
			...
			<div id="listCon">
				<div class="midCon">
					<form:form method="POST" commandName="voTalkNotesSearchCondition">
						<table>
							<tr>
								<td align="right">
									年:
				...
				<c:if test="${amName!='(尚未指定)'}">
					<a href="requestAdd.htm" class="formIcon">申請 AM ${amName}</a>
				</c:if>
...
-->
							...
							<td align="left">
								<span style="font-size: 14"><a
									href="requestView.htm?noteId=${talkNotes.talkNoteId}">${talkNotes.talkTheme}</a>
								</span>
							</td>
							...
							<td align="left">
								<span style="font-size: 14">${talkNotes.status}</span>
							</td>
						</tr>
