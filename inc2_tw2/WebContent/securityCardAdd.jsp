...
<html>
	<head>
		...
		<title><s:message code="securitycard.add" text="新增門禁卡" /></title>
...
$(document).ready(function() {
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				<s:message
						code="my.your.position" text="您的位置" />><s:message code="securitycard.add" text="新增門禁卡" />
			</h2>
			...
			<div id="listCon">
				<form:form id="myform" method="POST" commandName="securityCard"
					...
					<a href="securityCardList.htm" class="formIcon"><s:message
