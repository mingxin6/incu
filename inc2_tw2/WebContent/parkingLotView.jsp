...
<html>
	<head>
		...
		<title><s:message code="parking.info" text="停車位資訊" /></title>
...
$(document).ready(function() {
	...
	$("#dialog").dialog( {
		...
		buttons : {
			...
			$(this).dialog("close");
			self.location = "parkingLotDelete.htm?uid=${parkingLot.uid}";
		},
		"否" : function() {
			$(this).dialog("close");
		}
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				...
				>
				<s:message code="parking.info" text="停車位資訊" />
			</h2>
			...
			<div id="listCon">
				...
				<c:if test="${user.isStaff}">
					<a href="parkingLotEdit.htm?uid=${parkingLot.uid}" class="formIcon"><s:message
							code="my.edit" text="編輯" /> </a>

					<a href="parkingLotClear.htm?uid=${parkingLot.uid}"
