	...
	<body>
		...
		<div id="container">
			...
			<h2 id="listTit">
				...
				<span><s:message code="menuPart.consult.AM" text="我的 AM 輔導紀錄" /></span>
			</h2>

			<div id="listCon">
				<div class="midCon">
					<form:form method="POST" commandName="TalkNotesMyListAMController">
						<table>
							<tr>
								<td align="right">
						...
						<tr>
							...
							<td align="left">
								<span style="font-size: 14"><a
									href="talkNotesMyViewAM.htm?compName=${compName}&compId=${compId}&talkNoteId=${talkNotes.talkNoteId}">${talkNotes.talkTheme}</a>
								</span>
							</td>
