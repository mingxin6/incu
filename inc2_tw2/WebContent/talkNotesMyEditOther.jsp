...
<html>
	<head>
		...
		<title><s:message code="edit.other.consulting.record"
				text="編輯其他輔導記錄" />
		</title>
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				...
				>${compName}>
				<s:message code="edit.other.consulting.record" text="編輯其他輔導記錄" />
			</h2>



			<div id="listCon">
				<a href="talkNotesMyListOther.htm" class="formIcon"><s:message
