...
<html>
	<head>
		...
		<title><s:message code="reviewer.info" text="審查委員資訊" /></title>
...
$(document).ready(function() {
	...
	$("#dialog").dialog( {
		...
		buttons : {
			...
			$(this).dialog("close");
			self.location = "reviewerDelete.htm?uid=${reviewer.uid}";
		},
		"否" : function() {
			$(this).dialog("close");
		}
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				...
				> ${compName}
				<s:message code="reviewer.info" text="審查委員資訊" />
			</h2>

			<div id="listCon">

				<a href="reviewerList.htm" class="formIcon"><s:message
						code="my.back.to.list" text="回列表" /> </a>

				<c:if test="${user.isStaff}">
					<a href="reviewerEdit.htm?uid=${reviewer.uid}" class="formIcon"><s:message
