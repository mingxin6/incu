...
<html>
	<head>
		...
		<title><s:message code="request.AM" text="申請 AM 輔導" /></title>
...
-->
	...
	<body class="yui-skin-sam">
		...
		<div id="container">
			...
			<h2 id="listTit">
				<s:message code="request.AM" text="申請 AM 輔導" /> - ${TalkNotes.consultantName}
			</h2>

			<div id="listCon">

				<a href="requestListAM.htm" class="formIcon"><s:message code="my.back.to.list" text="回列表" /></a>
				<c:if test="${!TalkNotes.closed}">

					<a href="requestCloseAM.htm?noteId=${TalkNotes.talkNoteId}"
				...
				<table border='1' cellpadding="0" cellspacing="0" class="listTable"
					WIDTH="98%">
					<tr>
						<th align="right" width="20%" bgcolor=#CCCCCC>
